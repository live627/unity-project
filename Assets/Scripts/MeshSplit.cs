...
public class MeshSplit : MonoBehaviour
{
    ...
    public struct GridCoordinates
    {
        ...
        {
            return string.Format("({0},{1},{2})", x / precision, y / precision, z / precision);
        }
    }
    ...
    private void MapTrianglesToGridNodes()
    {
        ...
        for (int i = 0; i < baseTriangles.Length; i += 3)
        {
            ...
            // check if the dictionary has a key (our grid position). Add it / create a list for it if it doesn't.
